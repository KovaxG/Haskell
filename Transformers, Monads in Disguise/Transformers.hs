-- Based on the paper by [1]
-- [1] Martin Grabmueller 2006. Monad Transformers Step by Step
...
data Exp = Lit Integer -- expression
         | Var Name
         | Plus Exp Exp
...
type Env = Map.Map Name Value -- map from names to values           
